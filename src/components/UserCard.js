...
const UserCard = ({user}) => {
   return (
       <Card className="text-center mt-3 mb-4">
            <img src={user.avatar_url} className="img-fluid  img-thumbnail rounded fluid img-circle" alt="User Avatar" />
            <CardBody>
                <div className="text-primary">USERNAME: <b>{user.name}</b></div>
