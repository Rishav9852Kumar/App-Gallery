...
const Footer =() =>{
    ...
    {/*className="text-center bg-primary text-white text-uppercase fixed-bottom pb-2 "> */}
        ...
        <div><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Heart_coraz%C3%B3n.svg/800px-Heart_coraz%C3%B3n.svg.png"  id="footerlogo" alt="/"/> </div> 
      ...
      <div><img src="https://pngpress.com/wp-content/uploads/2020/08/uploads_github_github_PNG17.png" alt="/" id="footerlogo"/></div> 
